...
#! nix-shell -p flavours nodePackages.prettier -i bash
...
ayu: https://github.com/Z5483/base16-ayu-scheme
...
still-alive: https://github.com/deadly-platypus/base16-still-alive-scheme
...
synth-midnight: https://git.michaelball.name/base16-synth-midnight-scheme
tender: https://github.com/DanManN/base16-tender-scheme
tokyo-city: https://git.michaelball.name/gid/base16-tokyo-city-scheme
tokyo-night: https://git.michaelball.name/gid/base16-tokyo-night-scheme
...
flavours list -l | while read slug; do
    ...
    # Build scheme
    flavours build $scheme_path <( echo "$template_contents" ) > assets/schemes/$slug.css
